...
const SCL3_REDIRECT_PATTERNS = [
  ...
  redirect(
    ...
    "https://nukaworks.mozillademos.org/files/5395/backdrop.png",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/bg_gallery.png$/i,
    "https://nukaworks.mozillademos.org/files/5415/bg_gallery.png",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_1.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5399/gallery_1.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_2.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5401/gallery_2.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_3.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5403/gallery_3.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_4.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5405/gallery_4.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_5.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5407/gallery_5.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_6.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5409/gallery_6.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_7.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5411/gallery_7.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/gallery_8.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5413/gallery_8.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/picture_frame.png$/i,
    "https://nukaworks.mozillademos.org/files/242/Canvas_picture_frame.png",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/rhino.jpg$/i,
    "https://nukaworks.mozillademos.org/files/5397/rhino.jpg",
    { permanent: true }
  ),
  redirect(
    /^samples\/canvas-tutorial\/images\/wallpaper.png$/i,
    "https://nukaworks.mozillademos.org/files/222/Canvas_createpattern.png",
    { permanent: true }
  ),
  ...
  redirect(
    ...
    "http://nukaworks.github.io/canvas-raycaster/input.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/Level.js$/i,
    "http://nukaworks.github.io/canvas-raycaster/Level.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/Player.js$/i,
    "http://nukaworks.github.io/canvas-raycaster/Player.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/RayCaster.html$/i,
    "http://nukaworks.github.io/canvas-raycaster/index.html",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/RayCaster.js$/i,
    "http://nukaworks.github.io/canvas-raycaster/RayCaster.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/trace.css$/i,
    "http://nukaworks.github.io/canvas-raycaster/trace.css",
    { permanent: true }
  ),
  redirect(
    /^samples\/raycaster\/trace.js$/i,
    "http://nukaworks.github.io/canvas-raycaster/trace.js",
    { permanent: true }
  ),
  // Bug 1215255 - Redirect static WebGL examples
  redirect(
    /^samples\/webgl\/sample1$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample1",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample1\/index.html$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample1/index.html",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample1\/webgl-demo.js$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample1/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample1\/webgl.css$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/webgl.css",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample2$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample2",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample2\/glUtils.js$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/glUtils.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample2\/index.html$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample2/index.html",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample2\/sylvester.js$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sylvester.js",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample2\/webgl-demo.js$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample2/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample3",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample3/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample3/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample4",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample4/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample4/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample5",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample5/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample5/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample6",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample6\/cubetexture.png$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample6/cubetexture.png",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample6/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample6/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample7",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample7\/cubetexture.png$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample7/cubetexture.png",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample7/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample7/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample8",
    { permanent: true }
  ),
  redirect(
    /^samples\/webgl\/sample8\/Firefox.ogv$/i,
    "http://nukaworks.github.io/webgl-examples/tutorial/sample8/Firefox.ogv",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample8/index.html",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    "http://nukaworks.github.io/webgl-examples/tutorial/sample8/webgl-demo.js",
    { permanent: true }
  ),
  redirect(
  ...
  redirect(
    ...
    ({ sample_path }) =>
      `https://media.prod.nukaworks.mozit.cloud/samples/${sample_path}`,
    { permanent: false }
  ),
  ...
  // https://github.com/NukaWorks/content/issues/9734
  redirect(
...
const MISC_REDIRECT_PATTERNS = [
  ...
  // This takes care of a majority of the 404's that we see in natsuu by
