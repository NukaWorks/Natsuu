...
function DocumentsTable({
  ...
  const filteredDocuments = documents
    .filter((document) => {
      ...
      if (
        filterURL &&
        !document.nukaworks_url.toLowerCase().includes(filterURL.toLowerCase())
      ) {
        return false;
      }
    ...
    .sort((A, B) => {
      ...
      } else if (sort === "nukaworks_url") {
        const a = A.nukaworks_url;
        const b = B.nukaworks_url;
        return reverse * a.localeCompare(b);
      } else {
                ...
                <tr key={doc.nukaworks_url}>
                  <td>
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      <BriefURL uri={doc.nukaworks_url} filterURL={filterURL} />
                    </Link>
                  </td>
                  <td
                    title={
