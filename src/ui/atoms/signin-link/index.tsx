...
export default function SignInLink() {
  ...
  let prefix = "";
  // When doing local development with natsuu, the link to authenticate in Kuma
  ...
  if (
    ...
    import.meta.env.REACT_APP_KUMA_HOST
  ) {
    const combined = new URL(next, window.location.href);
    next = combined.toString();
    prefix = `http://${import.meta.env.REACT_APP_KUMA_HOST}`;
  }
