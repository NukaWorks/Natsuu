...
import {FXA_MANAGE_SUBSCRIPTIONS_URL, FXA_SETTINGS_URL, HEADER_NOTIFICATIONS_MENU_API_URL,} from "../../../constants";
...
export const UserMenu = () => {
  ...
  const userMenuItems = {
    ...
    items: [
      ...
      {
        url: "https://support.mozilla.org/products/nukaworks-plus",
        label: "Help",
      },
      {
        url: "https://github.com/NukaWorks/MDN-feedback",
        label: "Feedback",
      },
      {
        component: SignOut,
