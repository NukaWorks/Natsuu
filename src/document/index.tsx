...
import {useCopyExamplesToClipboard, useDocumentURL, usePersistFrequentlyViewed,} from "./hooks";
// Ingredients
    ...
    <>
      ...
      {doc.isTranslated ? (
        <div className="container">
          <LocalizedContentNote isActive={doc.isActive} />
        </div>
      ) : (
      ...
      <div className="article-wrapper">
        ...
        <MainContentContainer>
          {!isServer && !props.isPreview && doc.isActive && (
