...
DEFAULT_BUCKET_NAME = config("DEPLOYER_BUCKET_NAME", default="nukaworks-content-dev")
...
# You get this from https://speedcurve.com/mozilla-add-ons/nukaworks/admin/teams/
