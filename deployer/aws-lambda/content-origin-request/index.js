...
const { resolveFundamental } = require("@natsuu-internal/fundamental-redirects");
const { getLocale } = require("@natsuu-internal/get-locale");
const {
  decodePath,
  encodePath,
  slugToFolder,
} = require("@natsuu-internal/slug-utils");
const { VALID_LOCALES } = require("@natsuu-internal/constants");
...
//       temporary. For example, when we have moved to the natsuu-built
...
const CONTENT_DEVELOPMENT_DOMAIN = ".content.dev.nukaworks.mozit.cloud";
