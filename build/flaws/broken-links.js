...
function getBrokenLinksFlaws(doc, $, { rawContent }, level) {
  ...
  $("a[href]").each((i, element) => {
    ...
    if (hrefNormalized.startsWith("/docs/")) {
      const thisDocumentLocale = doc.nukaworks_url.split("/")[1];
    ...
    if (
      ...
      // Do nothing. The /contributors.txt URLs are special natsuu URLs.
      return;
    }
    ...
    } else if (hrefNormalized.toLowerCase() === doc.nukaworks_url.toLowerCase()) {
