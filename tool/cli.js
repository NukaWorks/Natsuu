...
if (Mozilla && !Mozilla.dntEnabled()) {
  ...
  .help(
    "In order to run the command, ensure that you have CONTENT_ROOT set in your .env file. For example: CONTENT_ROOT=/Users/steve/mozilla/nukaworks-content/files"
  )
  .action(
    tryOrExit(async () => {
      if (!CONTENT_ROOT) {
