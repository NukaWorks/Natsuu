    ...
    <div id="on-github" className="on-github">
      ...
      <ul>
        ...
        <li>
          ...
          <a
            href="https://github.com/NukaWorks/content/blob/main/README.md"
            target="_blank"
...
function fillMetadata(string, doc) {
  ...
  return string
    .replace(/\$PATHNAME/g, doc.nukaworks_url)
...
function NewIssueOnGitHubLink({ doc }: { doc: Doc }) {
  ...
  if (locale !== "en-US") {
    url.pathname = "/nukaworks/translated-content/issues/new";
    ...
    url.pathname = "/nukaworks/content/issues/new";
    sp.set("template", "page-report.yml");
    sp.set("nukaworks-url", `https://developer.mozilla.org${doc.nukaworks_url}`);
