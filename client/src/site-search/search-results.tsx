    ...
    <div className="search-results">
      ...
      <ul className="search-results-list readable-line-length">
        {documents.map((document) => {
          ...
          return (
            <li className="search-result-entry" key={document.nukaworks_url}>
              ...
              {document.highlight.title && document.highlight.title.length ? (
                ...
                <h3 className="title">
                  <a href={document.nukaworks_url}>{document.title}</a>
                </h3>
              )}{" "}
              ...
              <p className="search-result-url">
                <a href={document.nukaworks_url}>{document.nukaworks_url}</a>
              </p>
              <p>
                {highlights.length ? (
