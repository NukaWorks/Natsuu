      ...
      >
        <div>
          ...
          <input
            ...
            value={filters.nukaworks_url}
            onChange={(event) => {
              setFilters({ ...filters, nukaworks_url: event.target.value });
            }}
    ...
    return (
      <>
        ...
        <span className="url-slug">
          {filters.nukaworks_url ? getHighlightedText(right, filters.nukaworks_url) : right}
        </span>
      </>
    );
  }
  ...
  return (
    <div className="documents">
      ...
      <table>
        <thead>
          <tr>
            <TH id="nukaworks_url" title="Document" />
        ...
        <tbody>
          {documents.map((doc: Document) => {
            return (
              <tr key={doc.nukaworks_url}>
                <td>
                  <Link
                    to={`${doc.nukaworks_url}#_flaws`}
                    title={doc.title}
                    target="_blank"
                  >
                    {showBriefURL(doc.nukaworks_url)}
                  </Link>
