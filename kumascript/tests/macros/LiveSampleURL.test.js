...
describeMacro("LiveSampleURL", function () {
  ...
  itMacro("Production settings", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("Example"),
      "https://nukaworks.mozillademos.org/en-US/docs/Web/HTML/Element/p/_sample_.Example.html"
    );
  });
  itMacro("Override page URL", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      "https://nukaworks.mozillademos.org/en-US/docs/HTML/Forms/How_to_build_custom_form_widgets/Example_2/_sample_.No_JS.html"
    );
  });
  ...
  itMacro("Staging settings", function (macro) {
    macro.ctx.env.live_samples = {
      base_url: "https://files-stage.nukaworks.mozit.cloud",
    };
    macro.ctx.env.url = "/en-US/docs/Web/CSS/background-color";
    return assert.eventually.equal(
      macro.call("Examples"),
      "https://files-stage.nukaworks.mozit.cloud/en-US/docs/Web/CSS/background-color/_sample_.Examples.html"
    );
  });
  ...
  itMacro("Unicode ID", function (macro) {
    ...
    return assert.eventually.equal(
      macro.call("例子"),
      "https://nukaworks.mozillademos.org/zh-CN/docs/Web/CSS/flex-direction/_sample_.%E4%BE%8B%E5%AD%90.html"
    );
  });
