...
describeMacro("EmbedInteractiveExample", function () {
  itMacro("Typical settings and argument", function (macro) {
    macro.ctx.env.interactive_examples = {
      base_url: "https://interactive-examples.nukaworks.mozilla.net",
    };
    return assert.eventually.equal(
      macro.call("pages/css/animation.html"),
      `<h2>Try it</h2>
<iframe class="interactive is-default-height" height="200" src="https://interactive-examples.nukaworks.mozilla.net/pages/css/animation.html" title="MDN Web Docs Interactive Example"></iframe>`
    );
  });
...
<iframe class="interactive is-default-height" height="200" src="https://interactive-examples.nukaworks.mozilla.net/pages/css/animation.html" title="MDN Web Docs Interactive Example"></iframe>`
  ...
  itMacro("Javascript pages get an extra class by default", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      `<h2>Try it</h2>
<iframe class="interactive is-js-height" height="200" src="https://interactive-examples.nukaworks.mozilla.net/pages/js/expressions-conditionaloperators.html" title="MDN Web Docs Interactive Example"></iframe>`
    );
  });
  itMacro("An extra class can be passed as an argument", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      `<h2>Try it</h2>
<iframe class="interactive is-taller-height" height="200" src="https://interactive-examples.nukaworks.mozilla.net/pages/http/headers.html" title="MDN Web Docs Interactive Example"></iframe>`
    );
  });
});
