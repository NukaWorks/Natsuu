...
describeMacro("EmbedLiveSample", function () {
  beforeEachMacro(function (macro) {
    macro.ctx.env.live_samples = {
      base_url: "https://nukaworks.mozillademos.org",
    };
  ...
  itMacro("One argument: ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' id="frame_quotations"' +
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_sample_.quotations.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: ID with HTML entities (bug?)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/SVG/Element/switch/_sample_.svg_ltswitchgt_example.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: percent-encoded ID", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/SVG/Element/switch/_sample_.svg_switch_example.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: ID with percent-encoded page URL", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/fr/docs/Web/CSS/Utilisation_de_d%C3%A9grad%C3%A9s_CSS/_sample_.d%C3%A9grad%C3%A9s_lin%C3%A9aires_simples.html">' +
        "</iframe>"
    );
  });
  itMacro("One argument: XSS attempt (failed)", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_sample_.scriptalertxssscript.html">' +
        "</iframe>"
    );
  });
  itMacro("Two arguments: ID, width", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' id="frame_example"' +
        ' width="100%"' +
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/CSS/border-top-width/_sample_.example.html">' +
        "</iframe>"
    );
  });
  ...
  itMacro("Three arguments: ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/HTML/Element/figure/_sample_.images.html">' +
        "</iframe>"
    );
  });
  itMacro("Three arguments: unicode ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' id="frame_增加关键帧"' +
        ' width="100%" height="250"' +
        ' src="https://nukaworks.mozillademos.org/zh-CN/docs/Web/CSS/CSS_Animations/Using_CSS_animations/_sample_.%E5%A2%9E%E5%8A%A0%E5%85%B3%E9%94%AE%E5%B8%A7.html">' +
        "</iframe>"
    );
  });
  itMacro("Three arguments: url-encoded ID, width, height", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/zh-CN/docs/Web/API/Canvas_API/Tutorial/Basic_usage/_sample_.%E4%B8%80%E4%B8%AA%E6%A8%A1%E6%9D%BF%E9%AA%A8%E6%9E%B6.html">' +
        "</iframe>"
    );
  });
  ...
  itMacro('Four arguments: ID, width, height, ""', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/CSS/::before/_sample_.adding_quotation_marks.html">' +
        "</iframe>"
    );
  });
  itMacro("Four arguments: ID, width, height, screenshot", function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<table class="sample-code-table"><thead><tr>' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/SVG/Tutorial/Gradients/_sample_.svglineargradient.html">' +
  ...
  const same_slug_iframe =
    ...
    ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/CSS/flex-wrap/_sample_.examples.html">' +
    "</iframe>";
  ...
  itMacro('Five arguments: ID, "", "", "", other slug', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="sample-code-frame"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/Events/blur/_sample_.event_delegation.html">' +
        "</iframe>"
    );
  });
  itMacro(
    ...
    function (macro) {
      ...
      return assert.eventually.equal(
        ...
        '<iframe class="sample-code-frame"' +
          ' title="Event delegation sample"' +
          ' id="frame_event_delegation"' +
          ' src="https://nukaworks.mozillademos.org/en-US/docs/%22%3E%3Cscript%3Ealert(%22XSS%22);%3C/script%3E/_sample_.event_delegation.html">' +
          "</iframe>"
      );
    }
  );
  itMacro('Six arguments: ID, width, height, "", "", class', function (macro) {
    ...
    return assert.eventually.equal(
      ...
      '<iframe class="nobutton"' +
        ...
        ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/CSS/-moz-appearance/_sample_.samplenone.html">' +
        "</iframe>"
    );
  });
  itMacro(
    ...
    function (macro) {
      ...
      return assert.eventually.equal(
        ...
        '<iframe class="sample-code-frame"' +
          ...
          ' src="https://nukaworks.mozillademos.org/en-US/docs/Web/API/Media_Streams_API/Constraints/_sample_.example_constraint_exerciser.html"' +
