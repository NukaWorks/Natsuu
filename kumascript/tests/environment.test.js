...
const expectedFunctions = [
  ...
  "nukaworks.htmlEscapeArgs",
  "MDN.htmlEscapeArgs",
  "MDN.htmlescapeargs",
  "nukaworks.localString",
  "MDN.localString",
  "MDN.localstring",
  "nukaworks.localStringMap",
  "MDN.localStringMap",
  "MDN.localstringmap",
  "nukaworks.getLocalString",
  "MDN.getLocalString",
  "MDN.getlocalstring",
  "nukaworks.replacePlaceholders",
  "MDN.replacePlaceholders",
  "MDN.replaceplaceholders",
  "nukaworks.escapeQuotes",
  "MDN.escapeQuotes",
  "MDN.escapequotes",
...
describe("Environment class", () => {
  ...
  it("defines values from the environment object", () => {
    ...
    expect(getValue(context, "env.nukaworks")).toBe(2);
  });
