 ...
 * can use `this.nukaworks`, `this.wiki`, `this.env`, etc to refer to the parts
...
const nukaworksPrototype = require("./api/natsuu.js");
...
class Environment {
  ...
  constructor(
    ...
    const nukaworks = Object.create(prepareProto(nukaworksPrototype, globals));
    ...
    globals.MDN = globals.nukaworks = freeze(nukaworks);
